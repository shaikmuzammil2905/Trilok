...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // 1. Verify Secret Code (Server-Side)
    ...
    // 3. Perform Password Reset using SUPABASE_SERVICE_ROLE_KEY
    ...
    // Find User ID by Email in Supabase Auth Admin API
    ...
    if (updateRes.status === 200) {
      ...
      const errMsg = (updateRes.data && (updateRes.data.msg || updateRes.data.error_description || updateRes.data.message)) || 'Supabase Auth password reset failed.';
